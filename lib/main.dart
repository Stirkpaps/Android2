...
class Empresa extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: AppBar(
        title: new Text('Empresa Pizza Don piño'),
      ) //findeappbar
...
class Productos extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: AppBar(
        title: new Text('Productos Pizza Don piño'),
      ), //findeappbar
...
class Contactos extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: AppBar(
        title: new Text('Contactos Pizza Don Piño'),
      ), //findeappbar
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      body: Container(
        ...
        decoration: BoxDecoration(color: Colors.black, image: DecorationImage(image: NetworkImage("https://raw.githubusercontent.com/Stirkpaps/GALERIAfotos/main/origen-de-la-pizza-1.jpg"), alignment: Alignment.topCenter) //fin de decoration image
            ), //fin box decoration
